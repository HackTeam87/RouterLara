                        ...
                        <div class="col-md-6 services-grids w3layouts-grids">
                            ...
                            <div class="bs-docs-example">
                                <table class="table table-bordered" style="color: grey;font-family: 'Lato',sans-serif;" >
                                    ...
                                    <tbody>
                                    <p>Ціна: <b style="color:red; font-size:15px;">300 грн.</b></p>
                                    <tr>
                                    ...
                                    <tr>
                                        <td><b>Описание:</b></td>
                                        <td>Дає змогу під'єднати будь-які 4-дротові домофони до координатних багатоквартирних домофонів та забезпечує узгодження розмовних і керувальних ланцюгів відеомонітора та під'їзного домофона.Цей адаптер призначений для під'єднання багатоквартирних під'їзних домофонів «Візит», «Цифрал», «Метаком» до відеомоніторів брендів «Slinex», «Commax», «Gardi», «Kenwei» і забезпечує узгодження розмовних і керувальних ланцюгів відеомонітора та під'їзного домофона.</td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <div class="col-md-6 ">
                                ...
                                <div class="bs-docs-example">
                                    <table class="table table-bordered" style="color:gray;font-family: 'Lato', sans-serif;">
                                        ...
                                        <tr>
                                            <td><b>Тип антени (внутр / зовн):</b></td>
